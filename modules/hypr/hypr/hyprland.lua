...
local menu        = "tofi-drun --fuzzy-match=true --drun-launch=true"
...
hl.config({
	general = {
		...
		col              = {
			active_border   = { colors = { "rgba(c8d4dcee)", "rgba(708593ee)" }, angle = 45 },
			inactive_border = { colors = { "rgba(203039ee)", "rgba(0f2129ee)" }, angle = 45 },
		},
...
hl.bind(mainMod .. " + SHIFT + PRINT", hl.dsp.exec_cmd("hyprshot -m region -o ~/Pictures/hyprshot"))
